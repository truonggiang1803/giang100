...
namespace Lazada.Models
{
    ...
    public partial class QL_LAZADA_MB : DbContext
    {
        public QL_LAZADA_MB()
            : base("name=QL_LAZADA_MB")
        {
        }
        ...
        public DbSet<MSmerge_conflict_MIENBAC_ADMIN> MSmerge_conflict_MIENBAC_ADMIN { get; set; }
        public DbSet<MSmerge_conflict_MIENBAC_CT_HOADON> MSmerge_conflict_MIENBAC_CT_HOADON { get; set; }
        public DbSet<MSmerge_conflict_MIENBAC_HOADON> MSmerge_conflict_MIENBAC_HOADON { get; set; }
        public DbSet<MSmerge_conflict_MIENBAC_KHACHHANG> MSmerge_conflict_MIENBAC_KHACHHANG { get; set; }
        public DbSet<MSmerge_conflict_MIENBAC_KHUVUC> MSmerge_conflict_MIENBAC_KHUVUC { get; set; }
        public DbSet<MSmerge_conflict_MIENBAC_LOAIHANG> MSmerge_conflict_MIENBAC_LOAIHANG { get; set; }
        public DbSet<MSmerge_conflict_MIENBAC_NHACUNGCAP> MSmerge_conflict_MIENBAC_NHACUNGCAP { get; set; }
        public DbSet<MSmerge_conflict_MIENBAC_SANPHAM> MSmerge_conflict_MIENBAC_SANPHAM { get; set; }
        public DbSet<MSmerge_conflict_MIENBAC_sysdiagrams> MSmerge_conflict_MIENBAC_sysdiagrams { get; set; }
        public DbSet<MSmerge_conflict_MIENBAC_TK_KHACHHANG> MSmerge_conflict_MIENBAC_TK_KHACHHANG { get; set; }
        public DbSet<MSmerge_conflict_MIENBAC_TK_NCC> MSmerge_conflict_MIENBAC_TK_NCC { get; set; }

...
namespace Lazada.Models
{
    ...
    public partial class QL_LAZADA_MT : DbContext
    {
        public QL_LAZADA_MT()
            : base("name=QL_LAZADA_MT")
        {
        }
        ...
        public DbSet<MSmerge_conflict_MIENTRUNG_ADMIN> MSmerge_conflict_MIENTRUNG_ADMIN { get; set; }
        public DbSet<MSmerge_conflict_MIENTRUNG_CT_HOADON> MSmerge_conflict_MIENTRUNG_CT_HOADON { get; set; }
        public DbSet<MSmerge_conflict_MIENTRUNG_HOADON> MSmerge_conflict_MIENTRUNG_HOADON { get; set; }
        public DbSet<MSmerge_conflict_MIENTRUNG_KHACHHANG> MSmerge_conflict_MIENTRUNG_KHACHHANG { get; set; }
        public DbSet<MSmerge_conflict_MIENTRUNG_KHUVUC> MSmerge_conflict_MIENTRUNG_KHUVUC { get; set; }
        public DbSet<MSmerge_conflict_MIENTRUNG_LOAIHANG> MSmerge_conflict_MIENTRUNG_LOAIHANG { get; set; }
        public DbSet<MSmerge_conflict_MIENTRUNG_NHACUNGCAP> MSmerge_conflict_MIENTRUNG_NHACUNGCAP { get; set; }
        public DbSet<MSmerge_conflict_MIENTRUNG_SANPHAM> MSmerge_conflict_MIENTRUNG_SANPHAM { get; set; }
        public DbSet<MSmerge_conflict_MIENTRUNG_sysdiagrams> MSmerge_conflict_MIENTRUNG_sysdiagrams { get; set; }
        public DbSet<MSmerge_conflict_MIENTRUNG_TK_KHACHHANG> MSmerge_conflict_MIENTRUNG_TK_KHACHHANG { get; set; }
        public DbSet<MSmerge_conflict_MIENTRUNG_TK_NCC> MSmerge_conflict_MIENTRUNG_TK_NCC { get; set; }
